...
impl GameBoy {
    ...
    pub(in super::super) fn adc_8_8(&mut self, a: &mut u8, b: &u8) {
        // Handle carry
        let mut carry = 0;
    ...
    pub(in super::super) fn sbc_8_8(&mut self, a: &mut u8, b: &u8) {
        // Handle carry
        let mut borrow = 0;
        if self.reg_f & FlagMask::CARRY as u8 > 0x00 {
            borrow = 1;
    ...
    pub(in super::super) fn add_8_8(&mut self, a: &mut u8, b: &u8) {
        // Reset the flag register
        self.reg_f = 0x00;
    ...
    pub(in super::super) fn sub_8_8(&mut self, a: &mut u8, b: &u8) {
        // Reset the flag register
        self.reg_f = 0x00;
    ...
    pub(in super::super) fn add_16_s8(&mut self, a_h: &mut u8, a_l: &mut u8, b: &u8) {
    ...
    pub(in super::super) fn add_16_16(&mut self, a_h: &mut u8, a_l: &mut u8, b_h: &u8, b_l: &u8) {
        ...
        self.add_8_8(a_l, b_l);
        self.adc_8_8(a_h, b_h);

        // Restore the Z flag
        self.reg_f = self.reg_f & (!(FlagMask::ZERO as u8)) | temp_flag;
    }

    pub(in super::super) fn and_8(&mut self, a: &mut u8, b: &u8) {
    ...
    pub(in super::super) fn xor_8(&mut self, a: &mut u8, b: &u8) {
        // Set flag initial state
        self.reg_f = 0x00;
    ...
    pub(in super::super) fn or_8(&mut self, a: &mut u8, b: &u8) {
        // Set flag initial state
        self.reg_f = 0x00;
